		...
		@csrf
    		<table class="question-tbl">
    			<tr>
    				...
    				<!-- 問題 -->
    				<td class="textbox">
    					<input readonly class="input" type="text" name="question" value="{{ $question }}">
    		...
    		@if (is_array($answers))
        		...
        		<table>
        			<tr>
        				<th>答え:</th>
        				<td class="textbox">
        					<input  readonly class="input" type="text" name="answer[]" value="{{ $answer }}">
        				</td>
        			</tr>
        		</table>
        		@endforeach
    		...
    		@else
    			<table>
        			<tr>
        				<th>答え:</th>
        				<td class="textbox">
        					<input readonly class="input" type="text" name="answer" value="{{ $answers }}">
        				</td>
        			</tr>
        		</table>
			@endif
